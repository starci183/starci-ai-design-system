...
- **Cắt dòng "count" thừa khi list ĐÃ hiện item.** Dòng đếm tổng ("N thử thách", "N bộ · M thẻ") đặt dưới 1 list đã liệt kê các item = **vanity/lặp** (mắt đã thấy số item) → bỏ. Chỉ giữ count khi list **không** hiện item (vd group gập, chỉ show "n/m").
