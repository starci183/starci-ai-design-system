...
5. **PROD/VPS: trò KHÔNG tự SSH/authenticate vào server production.** Trò chuẩn bị script trọn vẹn (non-interactive) → **user bấm nút** chạy lệnh chạm prod; hoặc wire qua GitHub Actions secret (user set trên web, pipeline tự đẩy).
