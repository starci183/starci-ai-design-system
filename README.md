...
- **`starci-fe-ux-apply`** — build the proposal: **Opus writes a meticulous impl-spec, Sonnet codes it**, then verify.
...
---
> **Public read-only mirror.** Project/business-specific shelves (feature analysis, product/monetization
